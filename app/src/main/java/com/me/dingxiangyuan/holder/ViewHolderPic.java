...
//    private final TextView sift1_name;
    ...
    private final TextView sift1_forumType;
...
//        sift1_name = (TextView) itemView.findViewById(R.id.sift1_name);
        ...
        sift1_forumType = (TextView) itemView.findViewById(R.id.sift1_forumType);
    ...
    public void setData(Context context, SiftJsonBean.DataBean dataBean) {
                  if(dataBean.getImgs().size()!=0 && dataBean.getImgs().size()>2){
                      ...
                      Glide.with(context).load(dataBean.getImgs().get(0).getOriginalImg()).into(sift1_image);
                         Glide.with(context).load(dataBean.getImgs().get(0).getMiniImg()).into(sift1_image1);
...
//                      String t= format.format(new Date());
                      ...
                      sift1_forumType.setText(dataBean.getForumType()+"");
